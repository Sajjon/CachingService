...
public let ServiceEmptyOptionsInfo = [ServiceOptionsInfoItem]()
...
public extension RangeReplaceableCollection where Iterator.Element == ServiceOptionsInfoItem {
...
public func <== (lhs: ServiceOptionsInfoItem, rhs: ServiceOptionsInfoItem) -> Bool {
    switch (lhs, rhs) {
